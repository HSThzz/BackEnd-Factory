...
- README: remove MySQL/SQLite claims (only PostgreSQL is available)
- README and `package.json`: point repository/docs links to `HSThzz/BackEnd-Factory`
- Docs links now use absolute GitHub URLs so they work on the npm package page
